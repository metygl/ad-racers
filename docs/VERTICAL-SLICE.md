...
| ART-09 | VFX obscure events or fail to explain them | **FIXED** | Rivals get 40% of the player's effect budget; the boost core is capped; the drift release is grit along the ground plus a short spark rather than a screen-filling flare. |
